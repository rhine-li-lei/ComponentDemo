package com.lilei.beerouter_api.UIRouter;
...
import com.lilei.beerouter_api.utils.UriUtils;
...
public class UIRouter implements IUIRouter {
    ...
    private IComponentRouter fetch(@NonNull String host) {
        ...
        String path = "com.lilei.gen"+"."+ UriUtils.firstCharUpperCase(host)+"$Router";
